...
public final class WorldServer extends MappedObject<net.minecraft.server.level.WorldServer> {
    ...
    @Remap(classPath = "net.minecraft.core.Registry", name = "BIOME_REGISTRY", type = Remap.Type.FIELD, remappedName = "aP")
    private static final ResourceKey<IRegistry<BiomeBase>> BIOME_REGISTRY = IRegistry.aP;
