...
public class WorldServer extends MappedObject<net.minecraft.server.level.WorldServer> {
    ...
    public void addEntity(com.bgsoftware.superiorskyblock.nms.v1_18_R2.mapping.world.entity.Entity entity, CreatureSpawnEvent.SpawnReason spawnReason) {
    ...
    public boolean addEntitySerialized(com.bgsoftware.superiorskyblock.nms.v1_18_R2.mapping.world.entity.Entity entity) {
