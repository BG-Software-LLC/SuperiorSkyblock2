...
public class SpikesCache implements LoadingCache<Long, List<SpikeFeature.EndSpike>> {
    ...
    @Override
    public List<SpikeFeature.EndSpike> get(Long worldSeed) throws ExecutionException {
        try {
    ...
    @Override
    public List<SpikeFeature.EndSpike> getUnchecked(Long worldSeed) {
        try {
            this.worldSeed = worldSeed;
    ...
    @Override
    public ImmutableMap<Long, List<SpikeFeature.EndSpike>> getAll(Iterable<? extends Long> keys) {
        throw new UnsupportedOperationException("This operation is not supported in SpikesCache.");
    }

    @Override
    public List<SpikeFeature.EndSpike> apply(Long worldSeed) {
        throw new UnsupportedOperationException("This operation is not supported in SpikesCache.");
    }
    ...
    @Override
    public ConcurrentMap<Long, List<SpikeFeature.EndSpike>> asMap() {
        throw new UnsupportedOperationException("This operation is not supported in SpikesCache.");
    }

    @Nullable
    @Override
    public List<SpikeFeature.EndSpike> getIfPresent(Object worldSeed) {
        throw new UnsupportedOperationException("This operation is not supported in SpikesCache.");
    }

    @Override
    public List<SpikeFeature.EndSpike> get(Long worldSeed, Callable<? extends List<SpikeFeature.EndSpike>> loader) throws ExecutionException {
        try {
            this.worldSeed = worldSeed;
    ...
    @Override
    public ImmutableMap<Long, List<SpikeFeature.EndSpike>> getAllPresent(Iterable<?> keys) {
        throw new UnsupportedOperationException("This operation is not supported in SpikesCache.");
    }

    @Override
    public void put(Long worldSeed, List<SpikeFeature.EndSpike> spikes) {
        try {
            this.worldSeed = worldSeed;
    ...
    private class InternalCacheLoader extends CacheLoader<BlockPos, List<SpikeFeature.EndSpike>> {
        ...
        @Override
        public List<SpikeFeature.EndSpike> load(BlockPos blockPos) {
            ...
            for (int i = 0; i < 10; ++i) {
                ...
                spikesList.add(new SpikeFeature.EndSpike(spikeX + blockPos.getX(),
                        spikeZ + blockPos.getZ(), radius, height, guarded));
            }
