...
import net.minecraft.server.v1_13_R1.CriterionTriggers;
import net.minecraft.server.v1_13_R1.DamageSource;
import net.minecraft.server.v1_13_R1.DragonControllerDying;
import net.minecraft.server.v1_13_R1.DragonControllerFly;
import net.minecraft.server.v1_13_R1.DragonControllerHold;
import net.minecraft.server.v1_13_R1.DragonControllerLanding;
import net.minecraft.server.v1_13_R1.DragonControllerLandingFly;
...
import net.minecraft.server.v1_13_R1.EnumDragonRespawn;
...
import net.minecraft.server.v1_13_R1.WorldGenEndGatewayConfiguration;
import net.minecraft.server.v1_13_R1.WorldGenEndTrophy;
...
public final class NMSDragonFight_v1_13_R1 implements NMSDragonFight {
    ...
    private static final class IslandDragonControllerFly extends DragonControllerFly {
        ...
        private void findNewTarget() {
            ...
            EnderDragonBattle enderDragonBattle = a.dt();
    ...
    private static final class IslandDragonControllerHold extends DragonControllerHold {
        ...
        private void findNewTarget() {
            EnderDragonBattle enderDragonBattle = this.a.dt();
