...
import net.minecraft.server.v1_11_R1.DragonControllerDying;
import net.minecraft.server.v1_11_R1.DragonControllerFly;
import net.minecraft.server.v1_11_R1.DragonControllerHold;
import net.minecraft.server.v1_11_R1.DragonControllerLanding;
import net.minecraft.server.v1_11_R1.DragonControllerLandingFly;
import net.minecraft.server.v1_11_R1.DragonControllerManager;
...
import net.minecraft.server.v1_11_R1.EnumDragonRespawn;
import net.minecraft.server.v1_11_R1.EnumParticle;
import net.minecraft.server.v1_11_R1.GameProfileSerializer;
import net.minecraft.server.v1_11_R1.IDragonController;
...
public final class NMSDragonFight_v1_11_R1 implements NMSDragonFight {
    ...
    private static final class IslandDragonControllerFly extends DragonControllerFly {
        ...
        private void findNewTarget() {
            ...
            EnderDragonBattle enderDragonBattle = a.db();
    ...
    private static final class IslandDragonControllerHold extends DragonControllerHold {
        ...
        private void findNewTarget() {
            EnderDragonBattle enderDragonBattle = this.a.db();
    ...
    private static final class IslandDragonControllerLanding extends DragonControllerLanding {
        ...
        public void b() {
            ...
            double originLocY = this.a.bv.locY + this.a.bv.length / 2.0F;
