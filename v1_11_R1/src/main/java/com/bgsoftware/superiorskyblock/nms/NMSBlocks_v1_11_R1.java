...
import net.minecraft.server.v1_11_R1.INamableTileEntity;
...
public final class NMSBlocks_v1_11_R1 implements NMSBlocks {
    ...
    private void setName(Object tileEntityInventoryHolder, String name){
        if(tileEntityInventoryHolder instanceof TileEntityChest){
            ...
            ((TileEntityShulkerBox) tileEntityInventoryHolder).a(name);
        }
    }
