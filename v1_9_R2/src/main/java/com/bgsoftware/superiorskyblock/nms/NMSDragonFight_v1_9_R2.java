...
import net.minecraft.server.v1_9_R2.DragonControllerDying;
import net.minecraft.server.v1_9_R2.DragonControllerFly;
import net.minecraft.server.v1_9_R2.DragonControllerHold;
import net.minecraft.server.v1_9_R2.DragonControllerLanding;
import net.minecraft.server.v1_9_R2.DragonControllerLandingFly;
import net.minecraft.server.v1_9_R2.DragonControllerManager;
...
import net.minecraft.server.v1_9_R2.EnumDragonRespawn;
import net.minecraft.server.v1_9_R2.EnumParticle;
import net.minecraft.server.v1_9_R2.GameProfileSerializer;
import net.minecraft.server.v1_9_R2.IDragonController;
...
import net.minecraft.server.v1_9_R2.WorldGenEndGateway;
import net.minecraft.server.v1_9_R2.WorldGenEndTrophy;
...
public final class NMSDragonFight_v1_9_R2 implements NMSDragonFight {
    ...
    private static final class IslandDragonControllerFly extends DragonControllerFly {
        ...
        private void findNewTarget() {
            ...
            EnderDragonBattle enderDragonBattle = a.cV();
    ...
    private static final class IslandDragonControllerHold extends DragonControllerHold {
        ...
        private void findNewTarget() {
            EnderDragonBattle enderDragonBattle = this.a.cV();
