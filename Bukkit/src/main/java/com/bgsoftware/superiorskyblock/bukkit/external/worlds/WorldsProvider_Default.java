package com.bgsoftware.superiorskyblock.bukkit.external.worlds;
...
public class WorldsProvider_Default implements WorldsProvider {
    ...
    private World loadWorld(String worldName, Difficulty difficulty, Dimension dimension) {
        ...
        if (Bukkit.getPluginManager().isPluginEnabled("Multiverse-Core")) {
            Bukkit.dispatchCommand(Bukkit.getConsoleSender(), "mv import " + worldName + " normal -g " + plugin.getPluginName());
            Bukkit.dispatchCommand(Bukkit.getConsoleSender(), "mv modify set generator " + plugin.getPluginName() + " " + worldName);
        }
