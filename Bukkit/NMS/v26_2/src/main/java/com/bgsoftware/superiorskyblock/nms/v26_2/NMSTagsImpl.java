...
public class NMSTagsImpl extends com.bgsoftware.superiorskyblock.nms.v26_2.AbstractNMSTags {
    ...
    protected CompoundTag setTagAndGetCompoundTag(ItemStack itemStack, String key, int value) {
        ...
        tagCompound.putInt("DataVersion", com.bgsoftware.superiorskyblock.nms.v26_2.AbstractNMSAlgorithms.DATA_VERSION);
    ...
    protected void loadEntity(net.minecraft.nbt.CompoundTag compoundTag, ServerLevel serverLevel, Location location) {
        try (ProblemReporter.ScopedCollector reporter = new ProblemReporter.ScopedCollector(this::toString, LOGGER)) {
            ...
            EntityType.loadEntityRecursive(input, serverLevel, EntitySpawnReason.NATURAL, entity -> {
