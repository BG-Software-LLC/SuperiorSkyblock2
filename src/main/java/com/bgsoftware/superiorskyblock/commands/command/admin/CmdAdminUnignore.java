...
public final class CmdAdminUnignore implements ICommand {
    ...
    public String getUsage() {
        return "island admin unignore <player-name/island-name>";
    }

    @Override
    public String getDescription() {
        return Locale.COMMAND_DESCRIPTION_ADMIN_UNIGNORE.getMessage();
    }
