...
public class CmdAccept extends BaseCommand implements ISuperiorCommand {

    @Override
    protected List<String> aliases() {
        return Lists.newLinkedList("accept", "join");
    }
    ...
    public void execute(SuperiorSkyblockPlugin plugin, CommandSender sender, String[] args) {
        ...
        IslandUtils.sendMessage(island, Message.JOIN_ANNOUNCEMENT, Lists.emptyList(), superiorPlayer.getName());
    ...
    public List<String> tabComplete(SuperiorSkyblockPlugin plugin, CommandSender sender, String[] args) {
        ...
        return args.length == 2 ? CommandTabCompletes.getOnlinePlayersWithIslands(plugin, args[1],
                plugin.getSettings().isTabCompleteHideVanished(), (onlinePlayer, onlineIsland) ->
                        onlineIsland != null && onlineIsland.isInvited(superiorPlayer)) : Lists.emptyList();
    }
