...
public final class CmdAdminAddWarpsLimit implements ISuperiorCommand {
    @Override
    ...
    public String getDescription(java.util.Locale locale) {
        return Locale.COMMAND_DESCRIPTION_ADMIN_ADD_WARPS_LIMIT.getMessage(locale);
    }
    ...
    public void execute(SuperiorSkyblockPlugin plugin, CommandSender sender, String[] args) {
        ...
        Executor.data(() -> islands.forEach(island -> island.setWarpsLimit(island.getWarpsLimit() + amount)));
