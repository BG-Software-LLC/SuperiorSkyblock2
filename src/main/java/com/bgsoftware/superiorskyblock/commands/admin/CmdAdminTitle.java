...
public class CmdAdminTitle implements InternalPlayersCommand {
    ...
    public List<CommandArgument<?>> getArguments() {
        return new CommandArgumentsBuilder()
                .add(CommandArgument.required("players", MultiplePlayersArgumentType.ONLINE_PLAYERS, Message.COMMAND_ARGUMENT_PLAYER_NAME, Message.COMMAND_ARGUMENT_ALL_PLAYERS))
