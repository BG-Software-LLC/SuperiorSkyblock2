...
public class CmdAdminRemoveBlockLimit extends BaseCommand implements IAdminIslandCommand {

    @Override
    protected List<String> aliases() {
        return Lists.newLinkedList("removeblocklimit", "remblocklimit");
    }
    ...
    public List<String> adminTabComplete(SuperiorSkyblockPlugin plugin, CommandSender sender, Island island, String[] args) {
        return args.length == 4 ? CommandTabCompletes.getMaterials(args[3]) : Lists.emptyList();
    }
