...
public class CmdAdminSetTeamLimit implements InternalIslandsCommand {
    ...
    public void execute(SuperiorSkyblockPlugin plugin, IslandsCommandContext context) {
        ...
        for (Island island : islands) {
            EventResult<Integer> eventResult = plugin.getEventsBus().callIslandChangeMembersLimitEvent(
