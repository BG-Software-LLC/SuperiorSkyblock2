...
public class CountsPagedObjectButton extends PagedObjectButton<MenuCounts, MenuCounts.BlockCount> {
    ...
    private CountsPagedObjectButton(TemplateItem buttonItem, GameSound clickSound, List<String> commands,
    ...
    public static class Builder extends PagedObjectBuilder<Builder, CountsPagedObjectButton, MenuCounts> {
        ...
        public CountsPagedObjectButton build() {
            return new CountsPagedObjectButton(buttonItem, clickSound, commands, requiredPermission,
