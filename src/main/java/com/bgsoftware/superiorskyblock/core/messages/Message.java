...
public enum Message {
    ...
    CHANGED_DISCORD,
    CHANGED_ENTITY_CATEGORY_LIMIT,
    CHANGED_ENTITY_CATEGORY_LIMIT_ALL,
    CHANGED_ENTITY_CATEGORY_LIMIT_NAME,
    ...
    COMMAND_ARGUMENT_ENTITY_CATEGORY("entity-category"),
    ...
    COMMAND_DESCRIPTION_ADMIN_ADD_ENTITY_CATEGORY_LIMIT,
    ...
    COMMAND_DESCRIPTION_ADMIN_REMOVE_ENTITY_CATEGORY_LIMIT,
    ...
    COMMAND_DESCRIPTION_ADMIN_SET_ENTITY_CATEGORY_LIMIT,
    ...
    ISLAND_INFO_ADMIN_ENTITY_CATEGORIES_LIMITS,
    ISLAND_INFO_ADMIN_ENTITY_CATEGORIES_LIMITS_LINE,
