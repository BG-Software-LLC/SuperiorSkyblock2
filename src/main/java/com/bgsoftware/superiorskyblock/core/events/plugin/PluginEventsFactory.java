...
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ATTEMPT_PLAYER_SEND_MESSAGE_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.BLOCK_STACK_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.BLOCK_UNSTACK_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.COMMANDS_UPDATE_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_BANK_DEPOSIT_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_BANK_WITHDRAW_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_BAN_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_BIOME_CHANGE_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_CHANGE_BANK_LIMIT_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_CHANGE_BLOCK_LIMIT_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_CHANGE_BORDER_SIZE_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_CHANGE_COOP_LIMIT_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_CHANGE_CROP_GROWTH_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_CHANGE_DESCRIPTION_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_CHANGE_DISCORD_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_CHANGE_EFFECT_LEVEL_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_CHANGE_ENTITY_LIMIT_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_CHANGE_GENERATOR_RATE_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_CHANGE_LEVEL_BONUS_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_CHANGE_MEMBERS_LIMIT_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_CHANGE_MOB_DROPS_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_CHANGE_PAYPAL_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_CHANGE_PLAYER_PRIVILEGE_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_CHANGE_ROLE_LIMIT_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_CHANGE_ROLE_PRIVILEGE_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_CHANGE_SPAWNER_RATES_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_CHANGE_WARPS_LIMIT_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_CHANGE_WARP_CATEGORY_ICON_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_CHANGE_WARP_CATEGORY_SLOT_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_CHANGE_WARP_ICON_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_CHANGE_WARP_LOCATION_EVENT;
...
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_CLEAR_ROLES_PRIVILEGES_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_CLOSE_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_CLOSE_WARP_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_COOP_PLAYER_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_CREATE_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_CREATE_WARP_CATEGORY_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_CREATE_WARP_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_DELETE_WARP_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_DISABLE_FLAG_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_DISBAND_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_ENABLE_FLAG_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_ENTER_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_ENTER_PORTAL_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_ENTER_PROTECTED_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_GENERATE_BLOCK_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_INVITE_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_JOIN_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_KICK_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_LEAVE_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_LEAVE_PROTECTED_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_LOCK_WORLD_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_OPEN_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_OPEN_WARP_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_QUIT_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_RATE_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_REMOVE_BLOCK_LIMIT_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_REMOVE_EFFECT_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_REMOVE_GENERATOR_RATE_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_REMOVE_RATING_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_REMOVE_ROLE_LIMIT_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_REMOVE_VISITOR_HOME_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_RENAME_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_RENAME_WARP_CATEGORY_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_RENAME_WARP_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_RESTRICT_MOVE_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_SCHEMATIC_PASTE_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_SET_HOME_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_SET_VISITOR_HOME_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_TRANSFER_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_UNBAN_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_UNCOOP_PLAYER_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_UNLOCK_WORLD_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_UPGRADE_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_WORLD_RESET_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_WORTH_CALCULATED_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.ISLAND_WORTH_UPDATE_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.MISSION_COMPLETE_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.MISSION_RESET_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.PLAYER_CHANGE_BORDER_COLOR_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.PLAYER_CHANGE_LANGUAGE_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.PLAYER_CHANGE_NAME_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.PLAYER_CHANGE_ROLE_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.PLAYER_CLOSE_MENU_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.PLAYER_OPEN_MENU_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.PLAYER_REPLACE_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.PLAYER_TOGGLE_BLOCKS_STACKER_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.PLAYER_TOGGLE_BORDER_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.PLAYER_TOGGLE_BYPASS_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.PLAYER_TOGGLE_FLY_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.PLAYER_TOGGLE_PANEL_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.PLAYER_TOGGLE_SPY_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.PLAYER_TOGGLE_TEAM_CHAT_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.PLUGIN_INITIALIZED_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.PLUGIN_INITIALIZE_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.PLUGIN_LOAD_DATA_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.POST_ISLAND_CREATE_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.PRE_ISLAND_CREATE_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.SEND_MESSAGE_EVENT;
import static com.bgsoftware.superiorskyblock.core.events.plugin.PluginEventType.SETTINGS_UPDATE_EVENT;
