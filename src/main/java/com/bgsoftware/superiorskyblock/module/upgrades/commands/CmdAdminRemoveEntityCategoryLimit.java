...
public class CmdAdminRemoveEntityCategoryLimit implements IAdminIslandCommand {

    @Override
    public List<String> getAliases() {
        return Arrays.asList("removeentitycategorylimit", "rementitycategorylimit");
    }

    @Override
    public String getPermission() {
        return "superior.admin.removeentitycategorylimit";
    }

    @Override
    public String getUsage(java.util.Locale locale) {
        return "admin removeentitycategorylimit <" +
    ...
    public String getDescription(java.util.Locale locale) {
        return Message.COMMAND_DESCRIPTION_ADMIN_REMOVE_ENTITY_CATEGORY_LIMIT.getMessage(locale);
    }
    ...
    public void execute(SuperiorSkyblockPlugin plugin, CommandSender sender, @Nullable SuperiorPlayer targetPlayer, List<Island> islands, String[] args) {
        ...
        for (Island island : islands) {
            if (PluginEventsFactory.callIslandRemoveEntityCategoryLimitEvent(island, sender, entityCategory)) {
                ++islandsChangedCount;
                island.removeEntityCategoryLimit(entityCategory);
            }
        }
