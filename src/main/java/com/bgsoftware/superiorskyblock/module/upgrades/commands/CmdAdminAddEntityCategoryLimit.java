...
public class CmdAdminAddEntityCategoryLimit implements IAdminIslandCommand {

    @Override
    public List<String> getAliases() {
        return Collections.singletonList("addentitycategorylimit");
    }

    @Override
    public String getPermission() {
        return "superior.admin.addentitycategorylimit";
    }

    @Override
    public String getUsage(java.util.Locale locale) {
        return "admin addentitycategorylimit <" +
    ...
    public String getDescription(java.util.Locale locale) {
        return Message.COMMAND_DESCRIPTION_ADMIN_ADD_ENTITY_CATEGORY_LIMIT.getMessage(locale);
    }
