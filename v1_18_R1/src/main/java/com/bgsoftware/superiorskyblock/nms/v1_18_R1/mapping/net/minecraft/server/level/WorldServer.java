...
import com.bgsoftware.superiorskyblock.nms.v1_18_R1.mapping.net.minecraft.world.level.entity.LevelEntityGetter;
...
import com.bgsoftware.superiorskyblock.nms.v1_18_R1.mapping.net.minecraft.world.level.GameRules;
import com.bgsoftware.superiorskyblock.nms.v1_18_R1.mapping.net.minecraft.world.level.StructureManager;
...
public class WorldServer extends MappedObject<net.minecraft.server.level.WorldServer> {
    ...
    public void addEntity(com.bgsoftware.superiorskyblock.nms.v1_18_R1.mapping.net.minecraft.world.entity.Entity entity, CreatureSpawnEvent.SpawnReason spawnReason) {
    ...
    public boolean addEntitySerialized(com.bgsoftware.superiorskyblock.nms.v1_18_R1.mapping.net.minecraft.world.entity.Entity entity) {
