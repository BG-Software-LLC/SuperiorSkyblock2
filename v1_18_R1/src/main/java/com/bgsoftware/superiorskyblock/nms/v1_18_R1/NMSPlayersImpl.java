...
public final class NMSPlayersImpl implements NMSPlayers {
    ...
    @Remap(classPath = "net.minecraft.world.level.Level", name = "OVERWORLD", type = Remap.Type.FIELD, remappedName = "f")
    private static final ResourceKey<World> OVERWORLD = World.f;
