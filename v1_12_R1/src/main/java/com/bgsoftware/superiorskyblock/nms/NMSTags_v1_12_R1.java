...
public final class NMSTags_v1_12_R1 implements NMSTags {
    ...
    public CompoundTag getNBTTag(LivingEntity livingEntity) {
        ...
        entityLiving.save(nbtTagCompound);
        //noinspection deprecation
        nbtTagCompound.setString("id", entityLiving.getSaveID() == null ? livingEntity.getType().getName() : entityLiving.getSaveID());
