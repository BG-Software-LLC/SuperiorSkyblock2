...
import net.minecraft.server.v1_10_R1.DragonControllerDying;
import net.minecraft.server.v1_10_R1.DragonControllerFly;
import net.minecraft.server.v1_10_R1.DragonControllerHold;
import net.minecraft.server.v1_10_R1.DragonControllerLanding;
import net.minecraft.server.v1_10_R1.DragonControllerLandingFly;
import net.minecraft.server.v1_10_R1.DragonControllerManager;
...
import net.minecraft.server.v1_10_R1.EnumDragonRespawn;
import net.minecraft.server.v1_10_R1.EnumParticle;
import net.minecraft.server.v1_10_R1.GameProfileSerializer;
import net.minecraft.server.v1_10_R1.IDragonController;
...
import net.minecraft.server.v1_10_R1.WorldGenEndGateway;
import net.minecraft.server.v1_10_R1.WorldGenEndTrophy;
...
public final class NMSDragonFight_v1_10_R1 implements NMSDragonFight {
    ...
    private static final ReflectField<EnderDragonBattle> DRAGON_BATTLE = new ReflectField<>(EntityEnderDragon.class, EnderDragonBattle.class, "bK");
    ...
    private static final class IslandDragonControllerFly extends DragonControllerFly {
        ...
        private void findNewTarget() {
            ...
            EnderDragonBattle enderDragonBattle = a.cZ();
    ...
    private static final class IslandDragonControllerHold extends DragonControllerHold {
        ...
        private void findNewTarget() {
            EnderDragonBattle enderDragonBattle = this.a.cZ();
