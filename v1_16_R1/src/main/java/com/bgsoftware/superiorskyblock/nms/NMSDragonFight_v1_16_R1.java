...
import net.minecraft.server.v1_16_R1.BlockPredicate;
...
import net.minecraft.server.v1_16_R1.DragonControllerDying;
import net.minecraft.server.v1_16_R1.DragonControllerFly;
import net.minecraft.server.v1_16_R1.DragonControllerHold;
import net.minecraft.server.v1_16_R1.DragonControllerLanding;
import net.minecraft.server.v1_16_R1.DragonControllerLandingFly;
...
import net.minecraft.server.v1_16_R1.EnumDragonRespawn;
...
import net.minecraft.server.v1_16_R1.ShapeDetectorBuilder;
import net.minecraft.server.v1_16_R1.TicketType;
import net.minecraft.server.v1_16_R1.TileEntity;
import net.minecraft.server.v1_16_R1.TileEntityEnderPortal;
import net.minecraft.server.v1_16_R1.Unit;
import net.minecraft.server.v1_16_R1.Vec3D;
import net.minecraft.server.v1_16_R1.World;
import net.minecraft.server.v1_16_R1.WorldGenEndGatewayConfiguration;
import net.minecraft.server.v1_16_R1.WorldGenEndTrophy;
...
public final class NMSDragonFight_v1_16_R1 implements NMSDragonFight {

    private static final ReflectField<EnderDragonBattle> DRAGON_BATTLE = new ReflectField<>(EntityEnderDragon.class, EnderDragonBattle.class, "bM");
    ...
    private static final class IslandEnderDragonBattle extends EnderDragonBattle {
        ...
        public void a(EntityEnderDragon entityEnderDragon) {
            ...
            if (!gateways.isEmpty()) {
                ...
                WorldGenerator.END_GATEWAY.b(WorldGenEndGatewayConfiguration.a())
                        .a(world, world.getStructureManager(), world.getChunkProvider().getChunkGenerator(), new Random(), blockPosition);
            }
        ...
        public void a(boolean flag) {
            ...
            worldGenEndTrophy.b(WorldGenFeatureConfiguration.k).a(world, world.getStructureManager(),
                    world.getChunkProvider().getChunkGenerator(), new Random(), exitPortalLocation.up(2));
        }
    ...
    private static final class IslandDragonControllerFly extends DragonControllerFly {
        ...
        private void findNewTarget() {
            int closestNode = a.eJ();
            Vec3D headLookVector = a.t(1.0F);
    ...
    private static final class IslandDragonControllerLanding extends DragonControllerLanding {
        ...
        public void b() {
            ...
            double originLocX = this.a.bv.locX();
            double originLocY = this.a.bv.e(0.5D);
            double originLocZ = this.a.bv.locZ();
