...
import net.minecraft.server.v1_16_R1.BlockFlowerPot;
...
public final class NMSBlocks_v1_16_R1 implements NMSBlocks {
    ...
    public void refreshChunk(org.bukkit.Chunk bukkitChunk) {
        ...
        PacketPlayOutMapChunk packetPlayOutMapChunk = new PacketPlayOutMapChunk(chunk, 65535, true);
    ...
    public int tickIslands(int random) {
        ...
        for(Pair<Island, List<org.bukkit.Chunk>> chunkPair : activeChunks){
            ...
            for(org.bukkit.Chunk bukkitChunk : chunkPair.getValue()) {
                Chunk chunk = ((CraftChunk) bukkitChunk).getHandle();
                WorldServer chunkWorld = chunk.world;
