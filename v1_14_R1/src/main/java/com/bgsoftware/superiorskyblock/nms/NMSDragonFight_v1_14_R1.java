...
import net.minecraft.server.v1_14_R1.DragonControllerDying;
import net.minecraft.server.v1_14_R1.DragonControllerFly;
...
import net.minecraft.server.v1_14_R1.DragonControllerManager;
...
import net.minecraft.server.v1_14_R1.EnumDragonRespawn;
...
import net.minecraft.server.v1_14_R1.WorldGenEndGatewayConfiguration;
...
public final class NMSDragonFight_v1_14_R1 implements NMSDragonFight {

    private static final ReflectField<EnderDragonBattle> DRAGON_BATTLE = new ReflectField<>(EntityEnderDragon.class, EnderDragonBattle.class, "bP");
    ...
    private static final class IslandEnderDragonBattle extends EnderDragonBattle {
        ...
        public void a(EntityEnderDragon entityEnderDragon) {
            ...
            if (!gateways.isEmpty()) {
                ...
                WorldGenerator.END_GATEWAY.generate(world, world.getChunkProvider().getChunkGenerator(), new Random(), blockPosition, WorldGenEndGatewayConfiguration.a());
            }
    ...
    private static final class IslandDragonControllerDying extends DragonControllerDying {
        ...
        public void c() {
            ...
            if (distance >= 100.0D && distance <= 22500.0D && !a.positionChanged && !a.y) {
    ...
    private static final class IslandDragonControllerHold extends DragonControllerHold {
        ...
        public void c() {
            ...
            if (distance < 100.0D || distance > 22500.0D || this.a.positionChanged || this.a.y)
                findNewTarget();
        }
    ...
    private static final class IslandDragonControllerLanding extends DragonControllerLanding {
        ...
        public void b() {
            ...
            double originLocX = this.a.bA.locX;
            double originLocY = this.a.bA.locY + this.a.bA.getHeight() / 2.0F;
            double originLocZ = this.a.bA.locZ;
