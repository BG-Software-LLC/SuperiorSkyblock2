...
import com.bgsoftware.superiorskyblock.nms.v1_14_R1.NMSCachedBlock;
import com.bgsoftware.superiorskyblock.nms.v1_14_R1.NMSUtils;
...
import net.minecraft.server.v1_14_R1.BlockPropertySlabType;
...
public final class NMSBlocks_v1_14_R1 implements NMSBlocks {
    ...
    static {
        ...
        fieldNameToName.put("ao", "level15");
        fieldNameToName.put("ah", "distance1-7");
        fieldNameToName.put("au", "distance7");
        fieldNameToName.put("ax", "chest-type");
        fieldNameToName.put("ay", "comparator-mode");
