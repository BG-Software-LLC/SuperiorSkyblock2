...
public final class IslandEnderDragonBattle extends EnderDragonBattle {
    ...
    @Remap(classPath = "net.minecraft.world.level.block.Blocks", name = "BEDROCK", type = Remap.Type.FIELD, remappedName = "B")
    private static final Block BEDROCK_BLOCK = Blocks.B;
